...
actual_texts = VariousBotText(
    ...
    'которые делают подготовку комфортнее, но <b>расходуют больше ресурсов</b>. '
    '\n\nЭто:'
    ...
    '\n\nЧтобы активировать новые фичи и поддержать проект на развитие бота, я добавил недорогую подписку. '
