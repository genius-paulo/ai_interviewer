...
#TODO: Здесь нужна фабрика, чтобы уйти от
# конкретной реализации AI-помощника
# и сделать его легко заменяемым
class AIInterviewer:
...
async def get_answer_the_question(final_prompt: str) -> str:
    ...
    try:
        ...
        return "Ошибка при получении подсказки от GigaChat"
